...
Fetch Movie Data: Utilize the Fetch API to make HTTP requests to a movie database API (such as OMDB API) to fetch additional attributes for the movie from the API and store it in the JSON file.
